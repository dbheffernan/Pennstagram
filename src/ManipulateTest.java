...
/*	@Test public void middleCountTest() {
    assertEquals("regular count", 9, AdvancedManipulations.cellsAverage(1, 20, 20, 40, 40));
}
	
	@Test public void edgeCountTest() {
	    assertEquals("regular count", 25, AdvancedManipulations.cellsAverage(3, 1, 1, 40, 40));
	}

	@Test public void edgeRightCountTest() {
	    assertEquals("regular count", 25, AdvancedManipulations.cellsAverage(3, 39, 39, 40, 40));
	}*/
